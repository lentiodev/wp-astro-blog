...
export enum MediaItemSizeEnum {
  /** MediaItem with the bunyad-768 size */
  Bunyad_768 = 'BUNYAD_768',
  /** MediaItem with the bunyad-full size */
  BunyadFull = 'BUNYAD_FULL',
  /** MediaItem with the bunyad-medium size */
  BunyadMedium = 'BUNYAD_MEDIUM',
  /** MediaItem with the bunyad-small size */
  BunyadSmall = 'BUNYAD_SMALL',
  /** MediaItem with the bunyad-viewport size */
  BunyadViewport = 'BUNYAD_VIEWPORT',
...
export enum MenuLocationEnum {
  /** Put the menu in the smartmag-footer-links location */
  SmartmagFooterLinks = 'SMARTMAG_FOOTER_LINKS',
  /** Put the menu in the smartmag-main location */
  SmartmagMain = 'SMARTMAG_MAIN',
  /** Put the menu in the smartmag-mobile location */
  SmartmagMobile = 'SMARTMAG_MOBILE'
}
...
/** The template assigned to the node */
export type Template_AuthorsList = ContentTemplate & {
  __typename?: 'Template_AuthorsList';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
...
export type Template_Pagebuilder = ContentTemplate & {
  __typename?: 'Template_Pagebuilder';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_PagebuilderNoPaddingsFullWidth = ContentTemplate & {
  __typename?: 'Template_PagebuilderNoPaddingsFullWidth';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};

/** The template assigned to the node */
export type Template_SitemapDeprecated = ContentTemplate & {
  __typename?: 'Template_SitemapDeprecated';
  /** The name of the template */
  templateName?: Maybe<Scalars['String']['output']>;
};
